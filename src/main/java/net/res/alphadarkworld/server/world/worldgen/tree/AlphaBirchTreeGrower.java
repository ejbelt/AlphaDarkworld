...
public class AlphaBirchTreeGrower extends AbstractTreeGrower {

    @Override
    protected ResourceKey<ConfiguredFeature<?, ?>> getConfiguredFeature(RandomSource pRandom, boolean pHasFlowers) {
        /*if (Math.abs(pRandom.nextInt()) >= 900000000) {
            return AlphaConfiguredFeatures.GIANT_ALPHA_BIRCH_TREE_KEY;
        }
        return AlphaConfiguredFeatures.ALPHA_BIRCH_TREE_KEY;*/
        return null;
    }
